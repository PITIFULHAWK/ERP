  ...
  useEffect(() => {
    const fetchUniversities = async () => {
      try {
        ...
        toast({
          title: "Error",
          description: "Failed to load universities. Please refresh the page.",
          variant: "destructive",
        });
      } finally {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Join AcademiaOS</h1>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value} disabled={isLoading || loadingUniversities}>
                        <FormControl>
                          <SelectTrigger>
