...
const courses = [
    {
        ...
        description:
            "Comprehensive program covering software development, algorithms, data structures, and emerging technologies in computer science.",
    ...
    },
    {
        ...
        description:
            "Focus on electronic devices, communication systems, signal processing, and telecommunications technology.",
        duration: "4 Years | 8 Semesters",
        keySubjects: [
            "Circuit Design",
            "Signal Processing",
    ...
    },
    {
        ...
        description:
            "Study of design, manufacturing, and maintenance of mechanical systems and thermal devices.",
        duration: "4 Years | 8 Semesters",
        keySubjects: [
            "Thermodynamics",
            "Fluid Mechanics",
    ...
    },
    {
        ...
        description:
            "Advanced program focusing on machine learning, deep learning, natural language processing, and AI applications.",
    ...
    },
    {
        ...
        description:
            "Comprehensive business program covering management, finance, marketing, and strategic planning.",
        duration: "2 Years | 4 Semesters",
        keySubjects: [
